...
![在arcmap中看style文件](./img/qgis/style2sld/style一览.png)  
...
![修改源码](./img/qgis/style2sld/UnicodeDecodeError.png)  


#### 2 简单样式没问题了,但是有图片的样式会报错 。。。 ? 

![emf2svg报错](./img/qgis/style2sld/emf2svg.png)  

 [参考](https://www.reddit.com/r/gis/comments/b0ywud/convert_style_to_qgis_xml/)  


![解决emf2svg报错](./img/qgis/style2sld/解决emf2svg报错.png)
