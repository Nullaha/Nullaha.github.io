...
在左侧栏的`瓦片图层`下可以找到该图层。  
![geoserver-瓦片图层目录](./img/geoserver/发布图层服务/瓦片图层.png)  

你可以预览一下  
![geoserver-瓦片图层预览](./img/geoserver/发布图层服务/瓦片图层预览.png)  

![geoserver-瓦片图层预览2](./img/geoserver/发布图层服务/预览2.png)  
...
![geoserver-瓦片方案目录](./img/geoserver/发布图层服务/切片方案.png)  
